...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendImage( Bitmap image ) {
        SendImageAPI service = RetrofitClientInstance.getRetrofitDjangoInstanc().create( SendImageAPI.class );

        Call callUpload = service.uploadImage( new Base64Image( getBitMap( image ) ) );
